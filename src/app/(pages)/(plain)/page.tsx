...
const SplashScreen = ({ showAnimation }: { showAnimation: boolean }) => (
  <div className="h-full relative overflow-hidden" style={{ background: '#6592FD' }}>
    ...
    <div className="flex flex-col items-center justify-center h-full px-8">
      ...
      <h1
        className={`text-3xl font-bold text-white text-center transition-all duration-800 ${
          showAnimation ? "opacity-0 transform translate-y-4" : "opacity-100 transform translate-y-0"
        }`}
      >
        ToGather
      </h1>
...
const AuthSelectionScreen = ({ showButtons }: { showButtons: boolean }) => (
  <div className="h-full relative overflow-hidden bg-white">
    ...
    <div className="flex flex-col items-center justify-center h-full px-8">
      ...
      {/* Auth buttons */}
      <div className={`w-full max-w-xs space-y-4 transition-all duration-500 ${
