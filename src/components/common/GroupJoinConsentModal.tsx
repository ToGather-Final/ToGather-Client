...
interface GroupJoinConsentModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
}

export default function GroupJoinConsentModal({ isOpen, onClose, onConfirm }: GroupJoinConsentModalProps) {
